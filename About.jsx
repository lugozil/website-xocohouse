    ...
    <section className="section tight vals-sec" data-screen-label="About Values">
      <div className="container">
        ...
        <div className="vals-cta">
          <p className="vals-cta-p">Ready to start planning? Call us at <a href="tel:+13128746699" className="vals-phone">(312) 874-6699</a> or <a className="clink" href="contact.html">send us a message</a>.</p>
        </div>
      </div>
      <style>{`
